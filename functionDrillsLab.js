...
//CODE HERE
const jsNinja = () => {return 'I am a JavaScript ninja!'} // same as const jsNinja = () => 'I am a JavaScript ninja!'
console.log(jsNinja())
...
//CODE HERE
const compareNums = (num1, num2) => num1 > num2 ? num1 : num1 < num2 ? num2 : num1;
...
let resultArray = theEliminator(contestants, loser)
...
//CODE HERE
const sampleStringFunc = sampleString => `${sampleString.toUpperCase()}`
console.log(sampleStringFunc(sampleString))
...
const emailCheck = email => {
  ...
  if(email.includes('@')){
    ...
    return 'must provide a valied email address'
  }
}

let emailcheckVariable = emailCheck("  johndoe@gmail.com  ")
console.log(emailcheckVariable)
...
//CODE HERE
let chocFrog = amountOfGold => `${amountOfGold / 3}`
let totalFrogs = chocFrog(16)
...
//CODE HERE
let chocFrog2 = amountOfGold2 => `${Math.floor(amountOfGold2 / 3)}`
let totalFrogs2 = chocFrog2(16)
...
let arrayIsAscending = arrAscending(sampleArray)
